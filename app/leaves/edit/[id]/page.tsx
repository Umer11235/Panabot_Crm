...
import { calculateDuration, handleFormChange } from '../../new/functions';
...
export default function EditLeavePage() {
  ...
  useEffect(() => {
    ...
    if (departmentOpen || positionOpen || statusOpen || leaveTypeOpen) {
      document.addEventListener('click', handleClickOutside);
    }
    return () => document.removeEventListener('click', handleClickOutside);
  }, [departmentOpen, positionOpen, statusOpen, leaveTypeOpen]);
